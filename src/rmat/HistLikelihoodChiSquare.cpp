...
HistLikelihoodChiSquare::HistLikelihoodChiSquare(shared_ptr<TH1> data, shared_ptr<TH1> model) : HistChiSquare{data,model} {}

HistLikelihoodChiSquare::~HistLikelihoodChiSquare() {}
    
double HistLikelihoodChiSquare::Evaluate()
{
  CheckDimension();
